...
-d data/post_fire_model_Scenario2/training_patches/training_indices.json \
...
-d segmentation/data/ \
"python run_training.py --seed=11 --gpu=1 --save-images=1 --baseline=1 --model-name=resnetunet --group=resnetunet_Scenario2 --save-path=data/post_fire_model_Scenario2/"

...
class Model(pl.LightningModule):
    ...
    def __init__(self, hparams):
        ...
        self.model = UNet(hparams['n_channels'], hparams['decoders'], hparams['multiple'], hparams['num_layers'], hparams['residual'])
    ...
    def test_step(self, batch, batch_idx):
        ...
        scores = self.configuration['metric'](predicted_postproc,
                                           gt.cpu().numpy())
        out = {'metrics': scores,
    ...
    def configure_optimizers(self):
        ...
        if self.hparams['scheduler_type'] == None:
            ...
            if self.hparams['scheduler_type'] == "plateu":
                ...
                scheduler = lr_scheduler.OneCycleLR(self.optimizer, max_lr=self.hparams['lr'], epochs=self.hparams['max_epochs'], steps_per_epoch=self.hparams['steps_per_epoch'])
            else:
                raise  ValueError("Unspecified scheduler type: {}".format(self.hparams['scheduler_type']))
